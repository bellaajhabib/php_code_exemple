...
<div class="container">
    ...
    <div class="content">
        <div class="todo-container">
            <h1>Ma Todo</h1>
            <form class="todo-form" action=<?php echo $_SERVER['PHP_SELF']; ?> method="post">
            ...
            <div class="todo-list">
                <ul class="todo-list">
                    <?php foreach ($todos as $t) : ?>
                        <li class="todo-item <?= $t['dome'] ? 'low-opacity' : '' ?>">
                            <span class="todo-name"><?= $t['name'] ?></span>
                            <a href="todo-edit.php?id=<?= $t['id'] ?>">
                                <button class="btn btn-primary btn-small"><?= $t['dome'] ? 'Annuler' : 'Valider' ?></button>
                            </a>
